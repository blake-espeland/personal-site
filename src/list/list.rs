use super::item::{ListItem, ListItemProps};
use super::header::{ListHeader, ListHeaderProps};
...
impl From<ListItemProps> for Variants {
    fn from(props: ListItemProps) -> Self {
        Variants::Item(Rc::new(props))
    }
}

impl From<ListHeaderProps> for Variants {
    fn from(props: ListHeaderProps) -> Self {
